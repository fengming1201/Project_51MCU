...
INT8U OSTaskCreate(void (*task) (void* pd) reentrant, void* ppdata,
	OS_STK* ptos, INT8U prio) reentrant
{
#if OS_CRITICAL_METHOD == 3 				 /* Allocate storage for CPU status register			   */
	OS_CPU_SR cpu_sr;
#endif
...
INT8U OSTaskCreateExt(void   (*task) (void* pd) reentrant, void* ppdata,
	OS_STK* ptos, INT8U	prio, INT16U   id, OS_STK* pbos, INT32U   stk_size,
	void* pext, INT16U   opt) reentrant
{
#if OS_CRITICAL_METHOD == 3 				 /* Allocate storage for CPU status register			   */
	OS_CPU_SR cpu_sr;
#endif
